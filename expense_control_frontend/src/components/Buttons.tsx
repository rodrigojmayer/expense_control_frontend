...
export function OkButton({ sizeIco, cusField, clicked, widthIco }: ButtonProps ) {
...
export function CancelButton({ sizeIco, clicked }: ButtonProps) {
  const { classes } = useStylesGlobal();
  let fontIco = 35, noPadding, bor = 5, borRad
  if(sizeIco) {
    fontIco = (parseInt(sizeIco) - 12)
...
export function EditButton({ sizeIco, roundedIco, cusField, clicked, cusBorder, cusMarginTop, backgroundColor }: ButtonProps ) {
...
export function DeleteButton({ sizeIco, cusField, clicked, widthIco }: ButtonProps ) {
  const { classes } = useStylesGlobal();
  let noPadding, bor = 5, borRad
  if(sizeIco) {
    bor = 3
  }
  noPadding=0
...
export function AddButton({ sizeIco, cusMarginTop, cusField, clicked }: ButtonProps ) {
  const { classes } = useStylesGlobal();
  let bor = 4
  if(sizeIco) {
    bor = 1
